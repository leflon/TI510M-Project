...
(generate_random_string(), 'Xi''an Railway Station', 'Xi''an', 0x00000000010100000033C4B12E6E234140E3C798BB963C5B40),
(generate_random_string(), 'Chongqing Railway Station', 'Chongqing', 0x00000000010100000076E09C11A58D3D406C787AA52CA35A40),
...
(generate_random_string(), 'Suzhou Industrial Park Railway Station', 'Suzhou', 0x0000000001010000000B462575024A3F40F931E6AE252C5E40),
...
(generate_random_string(), 'Nanjing West Railway Station', 'Nanjing', 0x000000000101000000917EFB3A7006404067D5E76A2BAE5D40),
(generate_random_string(), 'Xi''an North Railway Station', 'Xi''an', 0x00000000010100000071AC8BDB683041407AC7293A92475B40),
(generate_random_string(), 'Chongqing North Railway Station', 'Chongqing', 0x000000000101000000B537F8C2649A3D407A36AB3E57A35A40),
(generate_random_string(), 'Beijing South Railway Station', 'Beijing', 0x000000000101000000E63FA4DFBEEE4340B1BFEC9E3C185D40),
(generate_random_string(), 'Wuchang Railway Station', 'Wuhan', 0x00000000010100000027A089B0E1893E403FC6DCB584945C40),
(generate_random_string(), 'Chengdu Railway Station', 'Chengdu', 0x00000000010100000050FC1873D7B23E406ADE718A8E045A40),
(generate_random_string(), 'Guangzhou East Railway Station', 'Guangzhou', 0x00000000010100000011C7BAB88D263740B84082E2C7545C40),
(generate_random_string(), 'Hangzhou Railway Station', 'Hangzhou', 0x000000000101000000567DAEB6623F3E409EEFA7C64B0B5E40),
...
(generate_random_string(), 'Chongqing West Railway Station', 'Chongqing', 0x00000000010100000005A3923A017D3D40DBF97E6ABCA05A40),
(generate_random_string(), 'Beijing West Railway Station', 'Beijing', 0x0000000001010000005F984C158CF24340AA8251499D145D40),
(generate_random_string(), 'Hankou Railway Station', 'Wuhan', 0x000000000101000000ADFA5C6DC59E3E40D3DEE00B93915C40),
(generate_random_string(), 'Chengdu East Railway Station', 'Chengdu', 0x00000000010100000061C3D32B65A93E405A643BDF4F095A40),
(generate_random_string(), 'Shenzhen North Railway Station', 'Shenzhen', 0x0000000001010000005DDC4603789B364060E5D022DB815C40),
(generate_random_string(), 'Hangzhou East Railway Station', 'Hangzhou', 0x0000000001010000000B24287E8C493E404BC8073D9B0D5E40),
...
(generate_random_string(), 'Shanghai Hongqiao Railway Station', 'Shanghai', 0x0000000001010000001904560E2D323F40A167B3EA73555E40),
